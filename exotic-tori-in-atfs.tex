...
\begin{figure}
  ...
  \end{tikzpicture}
  \caption{An almost toric base diagram with two non-isolated ATF-corners.}
...
Note a corner of the polygon $Δ$ might have multiple branch cuts meeting in it. (E.g.\ in \cref{fig:atf_example2}.)
