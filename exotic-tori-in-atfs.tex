...
\crefname{coro}{COROLARRY}{COROLARRIES}
...
\author{\firstname{Joé} \lastname{Brendel}}
\address{ETH Zürich}
\email[J. Brendel]{joe@brendel.lu}
\author{\firstname{Johannes} \lastname{Hauber}}
\address{Université de Neuchâtel}
\email[J. Hauber]{johannes.hauber@unine.ch}
\author{\firstname{Joel} \lastname{Schmitz}}
\address{Université de Neuchâtel}
\email[J. Schmitz]{joel.schmitz@unine.ch}
%\date{March 1, 2024}

\subjclass{53D12, 53D20, 14J17}
\keywords{}
...
Any $J$-curve $u$ escaping $π^{-1}(A_0)$ must have sufficiently large area.}
