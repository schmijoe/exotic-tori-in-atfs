...
Let us briefly give an example how we can use the displacement energy germ to distinguish tori. We will use the same technique for our main theorem \cref{thm:main}.
