...
\begin{proof}
  ...
  Now e.g.\ $\overline{A}$ describes the transformation of $Δ$ under a mutation at $N_1$, fixing the node $N_2$(see \todo{image}).
  ...
  After carefully analysing $τ$ (see \todo{image}), we get that it is linear on following wedges with the corresponding linear applications given by the boxed labels:
