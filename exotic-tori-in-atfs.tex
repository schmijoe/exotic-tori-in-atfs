      ...
      \begin{tikzpicture}[scale=0.9]
        \foreach \y in {0,1,2,3} {
          ...
          \begin{scope}[shift={(4*\y,-3)}]
            \draw (0,-1) node[anchor=110] {$[e]_{T^\y_{2,1}}$};
...
\begin{proof}[Proof of \cref{thm:A}]
    We show that if $[e]_{T^k_{pq}(a)} \circ Φ = [e]_{T^{k'}_{pq}(a')}$ for $Φ \in \operatorname{GL(2;\mathbb{Z})}$, then $a = a'$ and $k=k'$. Indeed, by \cref{thm:main}, ...
