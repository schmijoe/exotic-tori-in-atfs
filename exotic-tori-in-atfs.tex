...
\begin{proof}
  ...
  Next we want to establish the lower bound using \cref{thm:chekanov} and \cref{cor:small_buffer}. Choose a tubular neighbourhood $ι \colon μ^{-1}(∂U) × (0,1)$, and $B = ι(μ^{-1}(∂U), (0,\frac{1}{2}))$ a slightly smaller tubular neighbourhood.
