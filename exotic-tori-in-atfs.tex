...
As mentioned above, a fully decorated almost toric base diagram, defines a unique symplectic manifold.\todo{Beispielbild von almost toric base diagram.}
...
We refer to \cite[Example 8.15]{evans2021atfs} for an example.\todo{Bilder für die drei sachen.}
...
By a nodal slide, move the node across $(a,a)$ to obtain the Chekanov torus $T_{\text Ch}(a)$ over the point $(a,a)$.\todo{image}
\end{remark}
